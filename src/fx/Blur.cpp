...
void Blur::loop() {
    ...
    strip->paint((i + j) / 2, CHSV(ms / 29, 200, 255), true);
    strip->paint((j + k) / 2, CHSV(ms / 41, 200, 255), true);
    strip->paint((k + i) / 2, CHSV(ms / 73, 200, 255), true);
    strip->paint((k + i + j) / 3, CHSV(ms / 53, 200, 255), true);
}
